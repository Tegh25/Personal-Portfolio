...
function TerminalHero({ data }) {
  const lines = [
    ...
    '> interests: fpga, firmware, full-stack, space, robotics',
    '',
    ...
    '   Active: active (running) since 2003 — 23 years uptime',
    '   Tasks:  3 concurrent (mlh · satellite · formula)',
    '',
    '$ ./teghveer --help',
    'Usage: teghveer [role] [args...]',
    'Available roles:',
    '  swe-fellow              currently at MLH Fellowship',
